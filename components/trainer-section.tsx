...
export default function TrainerSections() {
  ...
  // Extended highlights array for more dynamic content
  const highlights = [
    { type: "video", src: "/placeholder.svg?height=400&width=600", title: "Elite Training Session" },
    { type: "image", src: "/placeholder.svg?height=400&width=600", title: "Professional Action Shot" },
    { type: "video", src: "/placeholder.svg?height=400&width=600", title: "Advanced Batting Techniques" },
    { type: "image", src: "/placeholder.svg?height=400&width=600", title: "Team Leadership Moment" },
    { type: "video", src: "/placeholder.svg?height=400&width=600", title: "Precision Fielding Drills" },
    { type: "image", src: "/placeholder.svg?height=400&width=600", title: "Championship Celebration" },
    { type: "video", src: "/placeholder.svg?height=400&width=600", title: "Game Winning Performance" },
    { type: "image", src: "/placeholder.svg?height=400&width=600", title: "Training Excellence" },
    { type: "video", src: "/placeholder.svg?height=400&width=600", title: "Skills Masterclass" },
    { type: "image", src: "/placeholder.svg?height=400&width=600", title: "Professional Portrait" },
    { type: "video", src: "/placeholder.svg?height=400&width=600", title: "Coaching Innovation" },
    { type: "image", src: "/placeholder.svg?height=400&width=600", title: "Victory Moment" },
    { type: "video", src: "/placeholder.svg?height=400&width=600", title: "Elite Performance" },
    { type: "image", src: "/placeholder.svg?height=400&width=600", title: "Training Dedication" },
    { type: "video", src: "/placeholder.svg?height=400&width=600", title: "Championship Level" },
    { type: "image", src: "/placeholder.svg?height=400&width=600", title: "Professional Excellence" },
  ]
    ...
    <div className="min-h-screen bg-white font-['Inter']">
      ...
      >
        ...
        <motion.section variants={itemVariants}>
            ...
            >
              <div className="w-40 h-40 mx-auto rounded-full bg-gradient-to-br from-red-500 to-orange-500 p-1 shadow-2xl">
                <div className="w-full h-full rounded-full overflow-hidden bg-white">
                  <Image
                    src="/Coach.jpg?height=160&width=160"
                    alt="Kevin Saenz Jr"
                    width={160}
                    height={160}
          ...
          {/* Dynamic Highlights Masonry Grid */}
            ...
            <div className="columns-1 md:columns-2 lg:columns-3 xl:columns-4 gap-6 space-y-6">
              {highlights.map((item, index) => (
                <motion.div
                  ...
                  className="group relative overflow-hidden rounded-2xl bg-white shadow-lg hover:shadow-2xl transition-all duration-500 break-inside-avoid mb-6"
                >
                    ...
                    {item.type === "video" && (
                      <div className="absolute inset-0 flex items-center justify-center">
                        <motion.div
                          ...
                          className="w-16 h-16 bg-gradient-to-r from-red-500 to-orange-500 rounded-full flex items-center justify-center shadow-xl border-4 border-white/30 backdrop-blur-sm"
                        >
